...
export type Registration={id:string;event_id:string;car_id:string;participant_id:string;car_number:string|null;vehicle_year:number;vehicle_make:string;vehicle_model:string;vehicle_color?:string|null;checked_in_at?:string|null;status:string|null;payment_status:string;classification:string|null;lions_choice_votes:number;participant:Participant;score:Score|null};
