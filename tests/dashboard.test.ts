...
test('dashboard uses registered denominators, snapshot makes and recorded car identity',()=>{
 ...
 assert.deepEqual([result.total,result.checked,result.paid,result.judged,result.newCars,result.returning],[3,2,2,1,2,1]);
