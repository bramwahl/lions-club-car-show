...
import { LayoutDashboard, ChartColumn, Users, CarFront, ClipboardList, Trophy, CalendarDays, UserCog, type LucideIcon } from 'lucide-react';
const icons:Record<string,LucideIcon>={'/admin':LayoutDashboard,'/admin/participants':Users,'/admin/registrations':CarFront,'/admin/scores':ChartColumn,'/admin/awards':Trophy,'/admin/events':CalendarDays,'/admin/users':UserCog,'/judge':ClipboardList};
